...
urlpatterns = [
    ...
    # User
    path('api/v1/user/register', User.create),
    path('api/v1/user/edit', User.edit),
    path('api/v1/user', User.find),
    path('api/v1/user/<int:user_id>', User.get),
    path('api/v1/user/login', User.login),
    path('api/v1/user/logout', User.logout),
    path('api/v1/user/checkLogin', User.checkLogin),
